...
const inviteCodes = ['BxM-8nyrcB-ayKCF65zm7g==@xFyW-YotdcrFoeRMDTsDeg==','nAZ-65wsFdqOEkAM0YqlKg==@BxM-8nyrcB-ayKCF65zm7g==@xFyW-YotdcrFoeRMDTsDeg=='];
...
!(async () => {
  ...
  await requireConfig();
  $.nextCode = ["BxM-8nyrcB-ayKCF65zm7g==", ""];
